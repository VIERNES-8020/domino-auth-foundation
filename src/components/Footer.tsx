    ...
    <footer className="mt-12 border-t">
      <div className="container mx-auto py-8 grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm">
        ...
        <nav aria-label="Enlaces" className="space-y-2">
          <Link className="story-link block" to="/properties">Propiedades</Link>
          <Link className="story-link block" to="/agents">Nuestros Agentes</Link>
          <Link className="story-link block" to="/about">Sobre Nosotros</Link>
          <Link className="story-link block" to="/contact">Contacto</Link>
        </nav>
        <div>
